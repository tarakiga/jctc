...
export function PremiumEvidenceManager({
  ...
  return (
    <div className="flex gap-6 min-h-[600px]">
      ...
      <div className="w-[35%] flex flex-col bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden max-h-[800px]">
        {/* Header */}
      ...
      <div className="w-[65%] flex flex-col bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden max-h-[800px]">
        {selectedEvidence ? (
          <>
            {/* Header */}
