...
async def list_user_reports(
    ...
    # Convert stored reports to ReportResponse objects
    reports_list = []
    ...
    # Apply filters
    if report_type:
        reports_list = [r for r in reports_list if r.report_type == report_type]
    if status_filter:
        reports_list = [r for r in reports_list if r.status == status_filter]
...
def generate_pdf_content(report_id: str, report_type: str, data: Dict[str, Any], output_path: Path):
    ...
    LOGO_PATH = Path("d:/work/Tar/Andy/JCTC/frontend/apps/web/public/logo.png")
